  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.spaceBetween}>
        ...
        <Icon icon="ic_check_square" size="medium" />
      </View>
      ...
      <View style={{flexDirection: 'row', alignItems: 'center', marginTop: 10}}>
        ...
        <View>
          <Text style={{fontWeight: 'bold', color: 'black', fontSize: 12}}>Milly, David</Text>
          <Text style={{color: 'gray', fontSize: 12}}>and 23 more liked this</Text>
        </View>
      </View>
    </View>
  )
