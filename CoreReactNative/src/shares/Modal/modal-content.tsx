...
import {StyleSheet, TouchableWithoutFeedback, useWindowDimensions, View, ViewStyle} from 'react-native'
...
import {CustomOmit, ModalProps} from './types'
import {
...
const ModalContentComponent = forwardRef(
  (
    ...
    const modalStyle = useMemo<ViewStyle>(
      () =>
        enhance<ViewStyle>([
          ...
          {
            width: screenWidth,
            height: screenHeight + (isIOS ? 0 : 35),
          },
        ]),
    ...
    const renderBackdrop = useCallback(() => {
      return (
        <TouchableWithoutFeedback onPress={onBackdropPress}>
          <Animated.View style={[backDropStyle, reBackdropStyle]}>{customBackDrop && customBackDrop}</Animated.View>
    ...
    }, [children, customGesture, hasGesture, onGesture, reContentStyle, style, wrapContentStyle])
